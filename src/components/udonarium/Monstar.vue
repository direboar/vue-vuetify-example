      ...
      <v-flex xs12>
        <v-card>
          ...
          <v-card-text>
            ...
            <br/>
            1.0.1<br/>
            OGLライセンスでの配布であることを明記。<br/>
            著作権上、画像ファイルの添付を廃止。<br/>
            支援先に、メールでのギフト券を追加。<br/>
            <br/>
            1.0.2<br/>
            入力元データに関する表現について、誤解を招く可能性があるため修正。<br/>
            「コマに含まれるデータについて」を追加。<br/>
            コマ作成に使用しているプログラムに関する記述をすべて削除。<br/>
            <br/>
            1.0.3<br/>
            脆弱性、抵抗、完全抵抗の情報を追加。<br/>
            ヒットポイントを最大値・最小値で表示するよう修正。<br/>
            </p>
          </v-card-text>
        </v-card>
        <v-card>
